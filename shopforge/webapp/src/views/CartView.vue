...
<template>
  <v-container class="py-8" style="max-width: 900px">
    ...
    >
      <v-icon size="64" color="grey-300" class="mb-4">fa:fas fa-cart-shopping</v-icon>
      <h3 class="text-h6 font-weight-medium mb-2" style="color: #475569">Nothing here yet</h3>
          ...
          <v-card-text class="pa-4">
            <div class="d-flex align-center gap-4">
              ...
              <div style="flex: 1; min-width: 0">
                <RouterLink
                  :to="{ name: 'product-detail', params: { slug: item.productSlug } }"
              ...
              <!-- Qty controls -->
              <div class="d-flex align-center border rounded-lg overflow-hidden" style="flex-shrink: 0">
                <v-btn
                  icon
                  variant="text"
                  size="small"
                ...
                <span class="px-3 text-body-2 font-weight-medium">{{ item.quantity }}</span>
                <v-btn
                  icon
                  variant="text"
                  size="small"
      ...
      <v-card rounded="xl" elevation="0" border>
        <v-card-text class="pa-6">
          <div class="d-flex justify-space-between mb-3">
            ...
            <span class="text-body-1 font-weight-medium">${{ cart.total }}</span>
          </div>
          <v-divider class="mb-4" />
          <div class="d-flex justify-space-between mb-5">
            <span class="text-h6 font-weight-bold" style="color: #1E293B">Total</span>
            <span class="text-h6 font-weight-bold" style="color: #1565C0">${{ cart.total }}</span>
          </div>
          <v-btn
            color="primary"
            variant="flat"
